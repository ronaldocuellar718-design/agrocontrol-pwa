...
import { el, vaciar, tarjetaKpi, actualizarTarjetaKpi, crearSelectPersonalizado } from "./componentesComunes.js";
...
function construirVistaCorporativa() {
  ...
  selectMesCorp = crearSelectPersonalizado({
    opciones: NOMBRES_MESES.map((n, i) => ({ value: i + 1, etiqueta: n })),
  ...
  return el("div", { style: "display:flex;flex-direction:column;gap:16px;" }, [
    el("div", { style: "display:flex;align-items:center;justify-content:space-between;" }, [
      ...
      el("div", { style: "display:flex;gap:6px;" }, [selectMesCorp.elemento, selectAnioCorp]),
    ]),
...
function construirVistaDetalle() {
  ...
  selectMesDetalle = crearSelectPersonalizado({
    opciones: NOMBRES_MESES.map((n, i) => ({ value: i + 1, etiqueta: n })),
    valorInicial: hoy.getMonth() + 1,
  ...
  return el("div", { style: "display:flex;flex-direction:column;gap:14px;" }, [
    ...
    el("div", { style: "display:flex;gap:6px;" }, [selectMesDetalle.elemento, selectAnioDetalle]),
